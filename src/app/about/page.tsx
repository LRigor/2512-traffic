...
const Section = ({
  ...
  <section
    className={`mb-8 p-6 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 ${className}`}
  >
    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed text-lg">
          ...
          tools. We help millions of users find the perfect AI solutions for
          their needs.
        </p>
      </div>
      ...
      <Section icon={<TargetIcon />} title="Our Mission">
        ...
        <p className="text-gray-700 leading-relaxed">
          We curate, review, and rank thousands of AI tools across diverse
          categories—from AI assistants and content creation to education and
          image generation. Our platform helps users make informed decisions by
          providing detailed comparisons, user reviews, and expert insights.
        </p>
      </Section>
        ...
        <div className="space-y-4 text-gray-700">
          <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            ...
            <div>
              ...
              Browse over 10,000 AI tools organized by category, use case, and
              features.
            </div>
          </div>
          <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            ...
            <div>
              <strong className="text-gray-900">Detailed Comparisons:</strong>{" "}
              Compare pricing, features, ratings, and user reviews to find the
              perfect fit.
            </div>
          </div>
          <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            ...
            <div>
              <strong className="text-gray-900">Community-Driven:</strong> Real
              reviews and ratings from our community of 3 million monthly users.
            </div>
          </div>
          <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            <div className="flex-shrink-0 w-8 h-8 bg-[#e94560] text-white rounded-full flex items-center justify-center font-semibold">
            ...
            <div>
              <strong className="text-gray-900">Daily Updates:</strong> Stay
              informed with daily launches, trending tools, and featured
              recommendations.
            </div>
          </div>
        </div>
      ...
      <Section icon={<LightbulbIcon />} title="Why Choose OpenTools?">
        ...
        <ul className="space-y-3 text-gray-700">
          <li className="flex items-start gap-3">
            ...
            <span>
              <strong>Curated Selection:</strong> Only the best and most
              reliable AI tools make it to our directory
            </span>
          </li>
          <li className="flex items-start gap-3">
            <span className="text-[#e94560] mt-1">✓</span>
            <span>
              <strong>Time-Saving:</strong> Compare multiple tools in minutes
              instead of hours of research
            </span>
          </li>
          <li className="flex items-start gap-3">
            <span className="text-[#e94560] mt-1">✓</span>
            <span>
              <strong>Expert Insights:</strong> Detailed feature breakdowns,
              pricing analysis, and use case recommendations
            </span>
          </li>
          <li className="flex items-start gap-3">
            <span className="text-[#e94560] mt-1">✓</span>
            <span>
              <strong>Free Access:</strong> All our resources and comparisons
      ...
      <div className="bg-gradient-to-br from-[#e94560] to-[#c23a52] rounded-2xl p-8 text-white text-center shadow-xl">
        ...
        <p className="text-white/90 mb-6 max-w-2xl mx-auto">
          Become part of the world&apos;s largest AI tools community. Discover
          new tools daily, share your experiences, and help others make better
          decisions.
        </p>
