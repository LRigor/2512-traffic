...
const faqData = [
  {
    ...
    questions: [
      {
        q: "What is aifinds?",
        a: "aifinds is a comprehensive directory of AI tools, featuring over 10,000 curated AI solutions across various categories. We help users discover, compare, and choose the best AI tools for their specific needs.",
      },
      {
        q: "Is aifinds free to use?",
        a: "Yes! aifinds is completely free to use. You can browse our entire directory, read reviews, compare tools, and access all features without any subscription or payment.",
      },
      {
      ...
      {
        q: "Can I submit a tool to aifinds?",
    ...
    questions: [
      {
        ...
        a: "aifinds itself is free. However, the AI tools listed may have their own pricing models (free, freemium, paid subscriptions, etc.). Pricing details are shown on each tool's page.",
      },
      {
    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed text-lg">
          Find answers to common questions about aifinds, our AI tools
          directory, and how to get the most out of our platform.
        </p>
      </div>
