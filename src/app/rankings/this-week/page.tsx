...
export const metadata: Metadata = {
  title: "Top AI Tools This Week | Weekly Rankings",
  description: "Discover the hottest AI tools This Week. See what's trending and gaining popularity in the AI tools community.",
};
      ...
      <div className="max-w-7xl mx-auto px-6 mb-12">
        <div className="mb-8">
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/rankings/this-week" className="px-6 py-3 rounded-lg font-medium transition-all bg-[#e94560] text-white shadow-lg">
              🔥 This Week
            </Link>
