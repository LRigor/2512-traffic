...
export const metadata: Metadata = {
  title: "Top Free AI Tools | Best Free AI Tools Rankings",
  description: "Discover the best free AI tools available. No subscription required - start using powerful AI tools for free today.",
};
      ...
      <div className="max-w-7xl mx-auto px-6 mb-12">
        <div className="mb-8">
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/rankings/free" className="px-6 py-3 rounded-lg font-medium transition-all bg-[#e94560] text-white shadow-lg">
              🆓 Free Tools
            </Link>
            <Link href="/rankings/paid" className="px-6 py-3 rounded-lg font-medium transition-all bg-white dark:bg-zinc-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-zinc-700 hover:border-[#e94560] hover:text-[#e94560]">
              💎 Paid Tools
            </Link>
          </div>
        </div>

        <RankingsList period="free" />
      </div>
    </>
  );
}
