...
export const metadata: Metadata = {
  title: "Top Paid AI Tools | Best Premium AI Tools Rankings",
  description: "Discover the best paid AI tools worth investing in. Professional-grade AI tools ranked by user ratings and popularity.",
};
      ...
      <div className="max-w-7xl mx-auto px-6 mb-12">
        <div className="mb-8">
          <div className="flex flex-wrap gap-3">
            <Link href="/rankings" className="px-6 py-3 rounded-lg font-medium transition-all bg-white dark:bg-zinc-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-zinc-700 hover:border-[#e94560] hover:text-[#e94560]">
              🏆 All Time
            </Link>
            <Link href="/rankings/this-month" className="px-6 py-3 rounded-lg font-medium transition-all bg-white dark:bg-zinc-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-zinc-700 hover:border-[#e94560] hover:text-[#e94560]">
              📅 This Month
            </Link>
            <Link href="/rankings/this-week" className="px-6 py-3 rounded-lg font-medium transition-all bg-white dark:bg-zinc-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-zinc-700 hover:border-[#e94560] hover:text-[#e94560]">
              🔥 This Week
            </Link>
            <Link href="/rankings/free" className="px-6 py-3 rounded-lg font-medium transition-all bg-white dark:bg-zinc-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-zinc-700 hover:border-[#e94560] hover:text-[#e94560]">
              🆓 Free Tools
            </Link>
            <Link href="/rankings/paid" className="px-6 py-3 rounded-lg font-medium transition-all bg-[#e94560] text-white shadow-lg">
              💎 Paid Tools
            </Link>
          </div>
        </div>

        <RankingsList period="paid" />
      </div>
    </>
  );
}
